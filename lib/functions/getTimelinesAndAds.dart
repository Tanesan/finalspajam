...
Future<List<TimelineAndAd>> getTimelinesAndAds(String id) async { //Future xxx async{} という記法
  ...
  for (int i=0; i<timelines.timelines.length; i++) {
      timelinesAndAds.add(
          TimelineAndAd(timeline: timelines.timelines[i], ad: ads.ads[i ~/ 4 ~/ ads.ads.length]));
  }
